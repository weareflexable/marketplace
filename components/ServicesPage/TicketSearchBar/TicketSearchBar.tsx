    ...
    return(
      <Box px='1em'>
        <Flex alignItems='center' mt='2em'  width={'100%'}> 
            <Text as='h2' height={'100%'} textStyle={'h4'} mb='4'>Showing you ticket for</Text>
            <Box ml='2'  height={'40px'} display='inline-block' w='100px'  position={'relative'}>
                ...
                <Input cursor='pointer' value={dayjs(date).format('dd/mm/yyyy')} opacity='0' sx={{'&::-webkit-calendar-picker-indicator':{position:'absolute', height:'100%', width:'100px'}}} position='absolute' left='0' top='0' h='100%' width='100px' type='date'  onChange={(event)=>handleDateChange(event)} variant='unstyled'/>
            </Box>
        </Flex>
      </Box>
    )
