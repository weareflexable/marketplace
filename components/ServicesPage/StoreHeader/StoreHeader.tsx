    ...
    return(
        <Flex mt='4' w='100%' position='relative' direction='column'>
            ...
            <Box height='250px' w='100%'>
                <Image width='100%' h='100%' objectFit={'contain'} src={`https://nftstorage.link/ipfs/bafybeicbhxma2bxu3terhbwpzgjiygybjd4ypsj5ajswl7ryctuumvjj44`} alt='Store header' />
            </Box>
            <Box p='2' zIndex='3' position='absolute' left='10' bottom='5'>
                <Heading color={'white'} textStyle={'h1'} as='h1' size='lg'>{storeName}</Heading>
                <HStack spacing='1'>
                    <MdLocationPin/>
                    <Link color='teal.500' href="https://www.google.com/maps/place/Benjamin's+On+Franklin/@43.0482687,-76.1579364,17z/data=!3m2!4b1!5s0x89d9f3c753d7908f:0x7ab6f929c8299aa7!4m5!3m4!1s0x89d9f3c75179c8a7:0x9266e055f7aa2091!8m2!3d43.0482648!4d-76.1557477"> {city?.charAt(0).toUpperCase()+city?.slice(1)}, {state?.toUpperCase()}</Link>
                </HStack>
            </Box>
        </Flex>
    )
