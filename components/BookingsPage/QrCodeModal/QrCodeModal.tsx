          ...
          <ModalBody>
            <VStack p="1em" spacing="2">
              ...
              <Image
                ...
                objectFit="fill"
                height={250}
                src={`https://nftstorage.link/ipfs/bafkreihpbepi6dhmk3jhvb5xjxgdtsigdjiz4cigaiwzauvw3hzj3h6bie`}
                alt="An image of the nft token"
              />
              {/* </Skeleton> */}
                ...
                <Flex direction="column">
                  <HStack spacing="2" mb="1">
                    ...
                    <Text color="cyan.700" textStyle={"caption"}>
                      <a href="https://www.google.com/maps/place/Benjamin's+On+Franklin/@43.0482687,-76.1579364,17z/data=!3m2!4b1!5s0x89d9f3c753d7908f:0x7ab6f929c8299aa7!4m5!3m4!1s0x89d9f3c75179c8a7:0x9266e055f7aa2091!8m2!3d43.0482648!4d-76.1557477">
                        314 S Franklin St Syracuse, NY 13206
                      </a>
                    </Text>
                  </HStack>
                  ...
                  <HStack spacing="2" mb="3">
                    ...
                    {tokenId ? (
                      <Text color="cyan.700" textStyle={"caption"}>
                        <a
                          href={`https://opensea.io/assets/matic/0x0632534712c3abef9922ce3bc587a2f27e25901f/${
                            tokenId && tokenId
                          }`}
                        >
                          View DAT on opensea
