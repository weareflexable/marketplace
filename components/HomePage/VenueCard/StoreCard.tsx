...
export const StoreCard = ({data}:StoreCardProps) =>{
    ...
    return(
        <Flex width={'100%'}  direction={'column'}  cursor='pointer' onClick={()=>navigateToServicePage(data.id)}>
            <Image border={'1px solid #333333'} borderRadius='6px'  src={`${process.env.NEXT_PUBLIC_NFT_STORAGE_PREFIX_URL}/${imageHash}`} m='0' maxW='100%' width='100%' objectFit={'contain'} height='250' alt={'Thumbnail image for cover'}/>
