      ...
      <Head>
        ...
        <Box position={'relative'}  h='100%' minH={'100vh'} layerStyle={'base'}> 
            ...
            <SimpleGrid mt='2' h={'100%'} columns={8} spacing='2'>
                ...
                <IconButton size={'lg'} width={'fit-content'} onClick={()=>router.back()} my={'1rem'} variant={'ghost'} colorScheme='brand' aria-label={'back to marketplace listing'} icon={<ChevronLeftIcon/>}/>
